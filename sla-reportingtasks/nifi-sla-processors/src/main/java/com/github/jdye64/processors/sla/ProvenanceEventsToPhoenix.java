...
public class ProvenanceEventsToPhoenix
    ...
    public void onTrigger(ProcessContext context, ProcessSession session) throws ProcessException {
        ...
        buffer.append(context.getProperty(PHOENIX_TABLE_NAME).evaluateAttributeExpressions(flowFile));
        ...
        try {
            ...
            for (int i = 0; i < events.length(); i++) {
                ...
                Map<String, String> attributes = generateAttributes(obj);
    ...
    private final  Map<String, String> generateAttributes(JSONObject obj) {
        ...
        attributes.put("sql.args.2.type", "-5");
        ...
        attributes.put("sql.args.14.type", "-5");
        ...
        attributes.put("sql.args.24.value", obj.getJSONObject("previousAttributes").getString("uuid"));
